...
set.seed(100)
data_set <- read.csv("C:/Users/bgh not/Downloads/arbolado-publico-mendoza-2021/arbolado-mza-dataset.csv")
data_test <- read.csv("C:/Users/bgh not/Downloads/arbolado-publico-mendoza-2021/arbolado-mza-dataset-test.csv")
